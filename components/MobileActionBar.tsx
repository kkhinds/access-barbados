...
export default function MobileActionBar() {
  return (
    <div
      className="md:hidden fixed inset-x-0 bottom-0 z-40 bg-white/95 backdrop-blur border-t border-mist-200 shadow-[0_-8px_24px_-12px_rgba(13,77,76,0.15)]
        dark:bg-navy-900/95 dark:border-navy-800"
    ...
    >
      <div className="grid grid-cols-3 gap-1 p-2">
        <a
          ...
          className="flex flex-col items-center justify-center gap-1 rounded-xl py-2 text-brand-700 hover:bg-brand-50 active:bg-brand-100
            dark:text-brand-300 dark:hover:bg-navy-800 dark:active:bg-navy-700"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="flex flex-col items-center justify-center gap-1 rounded-xl py-2 text-whatsapp-900 hover:bg-whatsapp-50 active:bg-whatsapp-50
            dark:text-whatsapp-500 dark:hover:bg-navy-800 dark:active:bg-navy-700"
        >
          <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
        ...
        <a
          href="#book"
          className="flex flex-col items-center justify-center gap-1 rounded-xl py-2 bg-brand-700 text-white hover:bg-brand-800 active:translate-y-px
            dark:bg-sky-500 dark:text-navy-900 dark:hover:bg-sky-300"
        >
          <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
